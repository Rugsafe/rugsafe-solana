...
# Shifted log to match initial point with the rugged token price
anticoin_price_up = np.log(10 / rugged_token_price_up) + (rugged_token_price_up[0] - np.log(10 / rugged_token_price_up[0]))
anticoin_price_down = np.log(10 / rugged_token_price_down) + (rugged_token_price_down[0] - np.log(10 / rugged_token_price_down[0]))
...
# Second subplot: Cr price going down and Ca price going up
ax2.plot(rugged_token_price_down, rugged_token_price_down, color='purple', label="Rugged Token Price ($C_r$)")
ax2.plot(rugged_token_price_down, anticoin_price_down, color='blue', label="Anticoin Price ($C_a$)")
